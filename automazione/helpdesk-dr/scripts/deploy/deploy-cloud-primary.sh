...
exec_cloud sh -lc "rm -rf /tmp/helpdesk-dr/manifests/kubernetes/cloud/app && mkdir -p /tmp/helpdesk-dr/manifests/kubernetes/cloud/app && cp /tmp/helpdesk-dr/app/main.py /tmp/helpdesk-dr/app/requirements.txt /tmp/helpdesk-dr/manifests/kubernetes/cloud/app/"
