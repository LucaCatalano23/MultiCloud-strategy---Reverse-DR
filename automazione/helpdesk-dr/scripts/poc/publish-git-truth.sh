...
exec_git bash -lc "test -d /srv/git/${APP_REPOSITORY_NAME} || git init --bare --initial-branch=main /srv/git/${APP_REPOSITORY_NAME}"
...
exec_git bash -lc "
  ...
  git --git-dir=/srv/git/${APP_REPOSITORY_NAME} symbolic-ref HEAD refs/heads/main
